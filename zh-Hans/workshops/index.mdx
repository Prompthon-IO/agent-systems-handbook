...
<CardGroup cols={2}>
  ...
  <Card title="Gmail OAuth 设置" icon="envelope" href="/zh-Hans/workshops/gmail-oauth-setup">
    为本地 Gmail 智能体入门项目创建 Google Cloud OAuth 凭据，包括 client ID、
    client secret、refresh token 和 scopes。
  </Card>
</CardGroup>
...
4. 当本地入门项目需要直接 Gmail API 发送或同步时，使用
   [Gmail OAuth 设置](/zh-Hans/workshops/gmail-oauth-setup)。
