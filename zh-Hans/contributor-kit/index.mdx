...
请先阅读 [贡献指南](https://github.com/Prompthon-IO/agentic-lab/blob/main/zh-Hans/CONTRIBUTING.md) 以了解共享流程，然后再来这里获取模板、指南和审阅资产。
...
- [Prompthon Agentic Lab 结构](/zh-Hans/contributor-kit/lab-structure)
