...
源代码：[case-studies/examples/customer-support-email-agent-starter](https://github.com/Prompthon-IO/agentic-lab/tree/main/case-studies/examples/customer-support-email-agent-starter)
