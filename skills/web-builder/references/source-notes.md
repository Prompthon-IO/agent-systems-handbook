...
Reviewed 2026-08-30. Behavioral reference: [upstream package](https://github.com/anthropics/skills/blob/3b3fad96af16a10759d930941b4520ba0c40edae/skills/frontend-design/SKILL.md). License finding: Apache-2.0 in that package's LICENSE.txt.

Copied: nothing. Rewritten: all skill instructions, templates, fixtures and Python helpers are original for this repository. Prompthon adaptations: distinct Build boundary, synthetic course workflow, shared scoped persistence, safety gates, readback, bilingual labs and reset guidance. No model prompt or script from another repository is vendored.
