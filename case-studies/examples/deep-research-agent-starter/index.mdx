...
Source code: [case-studies/examples/deep-research-agent-starter](https://github.com/Prompthon-IO/agentic-lab/tree/main/case-studies/examples/deep-research-agent-starter)
