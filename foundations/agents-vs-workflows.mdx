...
- Source input: [Chapter 1 Introduction to Agents](https://github.com/datawhalechina/Hello-Agents/blob/main/docs/chapter1/Chapter1-Introduction-to-Agents.md)
- Source input: [Hello-Agents upstream repository](https://github.com/datawhalechina/Hello-Agents)

## Reading Extensions

- [What Are Agent Systems](/foundations/what-are-agent-systems)
