...
- Source input: [Chapter 2 History of Agents](../references/hello-agents-main/docs/chapter2/Chapter2-History-of-Agents.md)
- Source input: [Hello-Agents reference boundary](../references/README.md)

## Reading Extensions

- [What Are Agent Systems](./what-are-agent-systems.md)
