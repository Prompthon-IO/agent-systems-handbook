...
| **Evaluation**               | Easy to define and measure             | Harder to define, but measurable enough to iterate                   |
...
* OpenAI, *A practical guide to building agents* — agent selection, guardrails, tool safeguards, output validation, and human intervention.
* Anthropic, *Building Effective Agents* — workflows versus agents and the recommendation to use the simplest solution that meets the requirements.
* Google Cloud, *Choose a design pattern for your agentic AI system* — human-in-the-loop patterns for high-stakes or critical actions.
* Microsoft, *Workflows* — explicit execution paths, deterministic workflow structure, and human-in-the-loop workflow patterns.
* Ragas, *Evaluation* — dataset-based evaluation and evaluation metrics.
* LangSmith, *Evaluation* — offline and online evaluation workflows.
* LangSmith, *Observability* — tracing and monitoring LLM applications.
* Langfuse, *Observability & Application Tracing* — tracing model calls, tools, retrieval, latency, and cost.
* AgentOps, *Introduction* — testing, debugging, deployment, and observability for AI agents and LLM applications.
