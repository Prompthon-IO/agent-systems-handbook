...
Source code: [systems/examples/weather-mcp-server-starter](https://github.com/Prompthon-IO/agentic-lab/tree/main/systems/examples/weather-mcp-server-starter)
