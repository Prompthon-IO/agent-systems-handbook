...
- Source input: [Chapter 4 Building Classic Agent Paradigms](../references/hello-agents-main/docs/chapter4/Chapter4-Building-Classic-Agent-Paradigms.md)
- Source input: [Hello-Agents reference boundary](../references/README.md)

## Reading Extensions

- [Reasoning And Control Patterns](./reasoning-and-control-patterns.md)
