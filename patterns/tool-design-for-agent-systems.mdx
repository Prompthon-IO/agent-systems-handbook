---
title: Tool Design For Agent Systems
owner: Prompthon IO
updated: 2026-08-01
depth: intermediate
region_tags:
...
external_readings:
  ...
  - title: Control and limit retry calls
    url: https://docs.aws.amazon.com/wellarchitected/latest/framework/rel_mitigate_interaction_failure_limit_retries.html
...
- Official source: [OpenAI function calling](https://developers.openai.com/api/docs/guides/function-calling)
- Official source: [OpenAI Agents SDK tools](https://openai.github.io/openai-agents-python/tools/)
- Official specification: [MCP tools](https://modelcontextprotocol.io/specification/2026-07-28/server/tools)
- Official specification: [MCP Schema Reference](https://modelcontextprotocol.io/specification/2026-07-28/schema)
- Official guide: [JSON Schema](https://json-schema.org/learn/getting-started-step-by-step)
- Official reference: [JSON Schema enumerated values](https://json-schema.org/understanding-json-schema/reference/enum)
- Official reference: [JSON Schema string constraints](https://json-schema.org/understanding-json-schema/reference/string)
- Official reference: [JSON Schema object properties](https://json-schema.org/understanding-json-schema/reference/object)
- Official guidance: [OWASP Top 10 for Agentic Applications](https://genai.owasp.org/resource/owasp-top-10-for-agentic-applications-for-2026/)
- Official guidance: [NIST AI Risk Management Framework 1.0](https://www.nist.gov/itl/ai-risk-management-framework)
- Official guidance: [AWS idempotent operations](https://docs.aws.amazon.com/wellarchitected/latest/framework/rel_prevent_interaction_failure_idempotent.html)
- Official guidance: [AWS retry limits](https://docs.aws.amazon.com/wellarchitected/latest/framework/rel_mitigate_interaction_failure_limit_retries.html)
...
- [Browser And Computer-Use Patterns](/patterns/browser-and-computer-use-patterns)
...
- 2026-08-01: Added the initial repo-native draft on schemas, least-privilege
  boundaries, failure semantics, observability, and testable success criteria.
