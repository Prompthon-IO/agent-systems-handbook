...
description: "Install Claude Code, connect project-scoped MCP tools, and use it as a repo-first local coding agent."
---
...
PowerShell, CMD, or WinGet. Do not start from older npm-based instructions: the
current Anthropic docs and the public `anthropics/claude-code` repo both treat
npm installation as deprecated.
...
- Compare this setup with [Codex Desktop Agent Setup](/workshops/desktop-agents/codex)
