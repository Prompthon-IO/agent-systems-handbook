---
title: "AI-Native Internship"
description: "PT01: a three-phase specialization in full-stack and agent engineering, from personalized coaching to open-source contribution and supervised real-project work."
---
...
This is a separate pathway from the six-class [GW02 · Professional AI Agent Course](/skills/professional-ai-agent-course). The internship has three phases; its 4–6 private coaching sessions make up Phase 1, not the entire program. The number of sessions depends on the student's existing skill proficiency.
...
2. Read the [contribution workflow](/contributor-kit/contribution-workflow), relevant repository instructions, and existing architecture or content.
...
- [GW02 · Professional AI Agent Course](/skills/professional-ai-agent-course) — the separate six-class short course.
- [Practitioner skills](/skills) — reusable packages for hands-on workflows.
- [Environment setup](/reading-paths/environment-setup) — prepare the development environment.
- [Contribution workflow](/contributor-kit/contribution-workflow) — follow the repository's contribution process.
